...
/**
 * Команда {@code replace_if_greater} – запрос на замену элемента по ключу,
 * если новое значение больше старого согласно естественному порядку
...
public class ReplaceIfGreaterCommand implements Command, Serializable {
    ...
    /**
     * Создаёт команду замены элемента при условии, что новое значение больше старого.
     *
     ...
     */
    public ReplaceIfGreaterCommand(String key, SpaceMarine newMarine) {
        this.key = key;
